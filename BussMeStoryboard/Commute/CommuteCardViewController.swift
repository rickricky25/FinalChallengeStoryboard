//
//  CommuteCardViewController.swift
//  BussMeStoryboard
//
//  Created by Ricky Effendi on 14/11/19.
//  Copyright © 2019 Ricky Effendi. All rights reserved.
//

import UIKit

class CommuteCardViewController: UIViewController {
    ...
    var cardViewController:CommuteViewController!
    ...
    func setupCard(){
        ...
        cardViewController = CommuteViewController(nibName: "CardViewController", bundle: nil)
        ...
        let tapGestureRecognizer = UITapGestureRecognizer(target: self, action: #selector(CommuteCardViewController.handleCardTap(recognizer:)))
        let panGestureRecognizer = UIPanGestureRecognizer(target: self, action: #selector(CommuteCardViewController.handleCardPan(recognizer:)))
